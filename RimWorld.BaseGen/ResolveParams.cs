...
namespace RimWorld.BaseGen
{
	public struct ResolveParams
	{
		...
		public override string ToString()
		{
			...
			expr_07[66] = ", clearEdificeOnly=";
			int arg_6DD_1 = 67;
			bool? flag7 = this.clearEdificeOnly;
			expr_07[arg_6DD_1] = ((!flag7.HasValue) ? "null" : this.clearEdificeOnly.ToString());
			expr_07[68] = ", clearFillageOnly=";
			int arg_719_1 = 69;
			bool? flag8 = this.clearFillageOnly;
			expr_07[arg_719_1] = ((!flag8.HasValue) ? "null" : this.clearFillageOnly.ToString());
			expr_07[70] = ", clearRoof=";
			int arg_755_1 = 71;
			bool? flag9 = this.clearRoof;
			expr_07[arg_755_1] = ((!flag9.HasValue) ? "null" : this.clearRoof.ToString());
			expr_07[72] = ", ancientCryptosleepCasketGroupID=";
			int arg_791_1 = 73;
			int? num7 = this.ancientCryptosleepCasketGroupID;
			expr_07[arg_791_1] = ((!num7.HasValue) ? "null" : this.ancientCryptosleepCasketGroupID.ToString());
			expr_07[74] = ", podContentsType=";
			int arg_7CD_1 = 75;
			PodContentsType? podContentsType = this.podContentsType;
			expr_07[arg_7CD_1] = ((!podContentsType.HasValue) ? "null" : this.podContentsType.ToString());
			expr_07[76] = ", thingSetMakerDef=";
			expr_07[77] = ((this.thingSetMakerDef == null) ? "null" : this.thingSetMakerDef.ToString());
			expr_07[78] = ", thingSetMakerParams=";
			int arg_836_1 = 79;
			ThingSetMakerParams? thingSetMakerParams = this.thingSetMakerParams;
			expr_07[arg_836_1] = ((!thingSetMakerParams.HasValue) ? "null" : this.thingSetMakerParams.ToString());
			expr_07[80] = ", stockpileConcreteContents=";
			expr_07[81] = ((this.stockpileConcreteContents == null) ? "null" : this.stockpileConcreteContents.Count.ToString());
			expr_07[82] = ", stockpileMarketValue=";
			int arg_8AE_1 = 83;
			float? num8 = this.stockpileMarketValue;
			expr_07[arg_8AE_1] = ((!num8.HasValue) ? "null" : this.stockpileMarketValue.ToString());
			expr_07[84] = ", innerStockpileSize=";
			int arg_8EA_1 = 85;
			int? num9 = this.innerStockpileSize;
			expr_07[arg_8EA_1] = ((!num9.HasValue) ? "null" : this.innerStockpileSize.ToString());
			expr_07[86] = ", edgeDefenseWidth=";
			int arg_926_1 = 87;
			int? num10 = this.edgeDefenseWidth;
			expr_07[arg_926_1] = ((!num10.HasValue) ? "null" : this.edgeDefenseWidth.ToString());
			expr_07[88] = ", edgeDefenseTurretsCount=";
			int arg_962_1 = 89;
			int? num11 = this.edgeDefenseTurretsCount;
			expr_07[arg_962_1] = ((!num11.HasValue) ? "null" : this.edgeDefenseTurretsCount.ToString());
			expr_07[90] = ", edgeDefenseMortarsCount=";
			int arg_99E_1 = 91;
			int? num12 = this.edgeDefenseMortarsCount;
			expr_07[arg_99E_1] = ((!num12.HasValue) ? "null" : this.edgeDefenseMortarsCount.ToString());
			expr_07[92] = ", edgeDefenseGuardsCount=";
			int arg_9DA_1 = 93;
			int? num13 = this.edgeDefenseGuardsCount;
			expr_07[arg_9DA_1] = ((!num13.HasValue) ? "null" : this.edgeDefenseGuardsCount.ToString());
			expr_07[94] = ", mortarDef=";
			expr_07[95] = ((this.mortarDef == null) ? "null" : this.mortarDef.ToString());
			expr_07[96] = ", pathwayFloorDef=";
			expr_07[97] = ((this.pathwayFloorDef == null) ? "null" : this.pathwayFloorDef.ToString());
			expr_07[98] = ", cultivatedPlantDef=";
			expr_07[99] = ((this.cultivatedPlantDef == null) ? "null" : this.cultivatedPlantDef.ToString());
			expr_07[100] = ", fillWithThingsPadding=";
			int arg_A9D_1 = 101;
			int? num14 = this.fillWithThingsPadding;
			expr_07[arg_A9D_1] = ((!num14.HasValue) ? "null" : this.fillWithThingsPadding.ToString());
			expr_07[102] = ", settlementPawnGroupPoints=";
			int arg_AD9_1 = 103;
			float? num15 = this.settlementPawnGroupPoints;
			expr_07[arg_AD9_1] = ((!num15.HasValue) ? "null" : this.settlementPawnGroupPoints.ToString());
			expr_07[104] = ", settlementPawnGroupSeed=";
			int arg_B15_1 = 105;
			int? num16 = this.settlementPawnGroupSeed;
			expr_07[arg_B15_1] = ((!num16.HasValue) ? "null" : this.settlementPawnGroupSeed.ToString());
			expr_07[106] = ", streetHorizontal=";
			int arg_B51_1 = 107;
			bool? flag10 = this.streetHorizontal;
			expr_07[arg_B51_1] = ((!flag10.HasValue) ? "null" : this.streetHorizontal.ToString());
			expr_07[108] = ", edgeThingAvoidOtherEdgeThings=";
			int arg_B8D_1 = 109;
			bool? flag11 = this.edgeThingAvoidOtherEdgeThings;
			expr_07[arg_B8D_1] = ((!flag11.HasValue) ? "null" : this.edgeThingAvoidOtherEdgeThings.ToString());
			expr_07[110] = ", allowPlacementOffEdge=";
			int arg_BC9_1 = 111;
			bool? flag12 = this.allowPlacementOffEdge;
			expr_07[arg_BC9_1] = ((!flag12.HasValue) ? "null" : this.allowPlacementOffEdge.ToString());
			expr_07[112] = ", thrustAxis=";
			int arg_C05_1 = 113;
			Rot4? rot2 = this.thrustAxis;
			expr_07[arg_C05_1] = ((!rot2.HasValue) ? "null" : this.thrustAxis.ToString());
