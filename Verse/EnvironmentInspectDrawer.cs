...
namespace Verse
{
	internal static class EnvironmentInspectDrawer
	{
		...
		{
			EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey0 <DrawInfoWindow>c__AnonStorey = new EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey0();
			<DrawInfoWindow>c__AnonStorey.room = UI.MouseCell().GetRoom(Find.VisibleMap, RegionType.Set_All);
			...
			EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey0 expr_8A_cp_0 = <DrawInfoWindow>c__AnonStorey;
			expr_8A_cp_0.windowRect.height = expr_8A_cp_0.windowRect.height + 25f;
			if (<DrawInfoWindow>c__AnonStorey.roomValid)
			{
				EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey0 expr_AC_cp_0 = <DrawInfoWindow>c__AnonStorey;
				expr_AC_cp_0.windowRect.height = expr_AC_cp_0.windowRect.height + 13f;
				EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey0 expr_C3_cp_0 = <DrawInfoWindow>c__AnonStorey;
				expr_C3_cp_0.windowRect.height = expr_C3_cp_0.windowRect.height + 23f;
				EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey0 expr_DA_cp_0 = <DrawInfoWindow>c__AnonStorey;
				expr_DA_cp_0.windowRect.height = expr_DA_cp_0.windowRect.height + (float)EnvironmentInspectDrawer.DisplayedRoomStatsCount * 25f;
			}
			EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey0 expr_F8_cp_0 = <DrawInfoWindow>c__AnonStorey;
			expr_F8_cp_0.windowRect.x = expr_F8_cp_0.windowRect.x + 26f;
			EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey0 expr_10F_cp_0 = <DrawInfoWindow>c__AnonStorey;
			...
			{
				EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey0 expr_13C_cp_0 = <DrawInfoWindow>c__AnonStorey;
				expr_13C_cp_0.windowRect.x = expr_13C_cp_0.windowRect.x - (<DrawInfoWindow>c__AnonStorey.windowRect.width + 52f);
			}
			if (<DrawInfoWindow>c__AnonStorey.windowRect.yMax > (float)UI.screenHeight)
			{
				EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey0 expr_175_cp_0 = <DrawInfoWindow>c__AnonStorey;
				expr_175_cp_0.windowRect.y = expr_175_cp_0.windowRect.y - (<DrawInfoWindow>c__AnonStorey.windowRect.height + 52f);
			}
